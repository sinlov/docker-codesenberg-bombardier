...
INFO_BUILD_DOCKER_IMAGE_NAME ?= sinlov/docker-codesenberg-bombardier
...
dockerTestRunLatest:
	...
	-docker run --rm --name ${INFO_TEST_TAG_BUILD_CONTAINER_NAME} ${INFO_BUILD_DOCKER_IMAGE_NAME}:${INFO_BUILD_DOCKER_TAG} --help
